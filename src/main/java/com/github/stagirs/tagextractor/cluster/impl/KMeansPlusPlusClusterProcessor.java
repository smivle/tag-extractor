 ...
 */
public class KMeansPlusPlusClusterProcessor implements ClusterProcessor{
    ...
    public void setClusters(StoreIterator<Tag> tags, Store<Tag> store){
        ...
        KMeansPlusPlusClusterer clusterer = new KMeansPlusPlusClusterer((int)Math.log(tagList.size()), 10);
        List<CentroidCluster<Vector>> list = clusterer.cluster(getVectors(tagList));
