 ...
 */
public class ClusterSemanticProcessorTest {
    @Test
    public void test() throws IOException{
        new ClusterSemanticProcessor().setSemantic(new StoreIterator<>(new File("tagsWithoutSemantic"), Tag.class), new Store<>(new File("tagsWithSemantic")));
    }
}
